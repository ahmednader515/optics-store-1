      ...
      <div className="w-full max-w-[1800px] mx-auto p-4 sm:p-6 md:p-8">
        ...
        <div className="mt-8 md:mt-12 lg:mt-16 text-center">
          ...
          <a href="/sign-in" className="inline-block">
            <button className="w-full max-w-sm md:max-w-lg font-cairo text-base md:text-lg h-10 md:h-12 bg-white border-2 border-orange-600 text-orange-600 hover:bg-orange-50 rounded-lg transition-colors">
              تسجيل الدخول
            </button>
          </a>
        </div>
